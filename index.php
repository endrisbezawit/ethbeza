    ...
    <section class="py-5">
      <div class="container py-4">
        <div class="row text-center">
          <div class="col-lg-8 mx-auto"><a class="category-link mb-3 d-inline-block" href="#">Ethiopia</a>
            <h1>Incredible Graffiti Art Spotted in East </h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis aliquid.</p>
            <ul class="list-inline mb-5">
              <li class="list-inline-item mx-2"><a class="text-uppercase text-muted reset-anchor" href="#">BY Samuel Binayam</a></li>
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <div class="row">
              <div class="col-lg-6 mb-4"><a class="d-block" href="img/post-demo-1.jpg" data-lightbox="post-images" title="Image one"><img class="img-fluid img-thumbnail" src="img/ethcoff.png" alt=""></a></div>
            ...
            <ul class="list-unstyled comments">
              ...
              <li>
                <div class="media mb-4"><img class="rounded-circle shadow-sm img-fluid" src="img/person-3.jpg" alt="" width="60">
                  <div class="media-body ml-3">
          ...
          <div class="col-lg-3">
            ...
            <div class="card rounded-0 border-0 bg-light mb-4 py-lg-4">
              <div class="card-body text-center">
                <h2 class="h3 mb-3">About me</h2><img class="rounded-circle mb-3" src="img/authorb.jpg" alt="..." width="100">
