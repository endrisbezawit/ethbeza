    ...
    <a href="#">Bezawit E.</a>
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <div class="row">
              <div class="col-lg-6 mb-4"><a class="d-block" href="img/ethcoff.png" data-lightbox="post-images" title="Image one"><img class="img-fluid img-thumbnail" src="img/ethcoff.png" alt=""></a></div>
